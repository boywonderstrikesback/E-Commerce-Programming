...
<style type ="text/css">
    ...
    #list_users table tr td.first, #list_users table tr td.third, #list_supplements table tr td.first, #list_supplements table tr td.third, #list_supplements table tr td.fifth,#list_orders table tr td.first, #dlist_orders table tr td.third, #list_orders table tr td.fifth, #list_orders table tr td.seventh{
        background: purple;
        color: white;
    }
    ...
    #admin_main_menu, #admin_main_menu, #list_users, #list_supplements {
        margin: 0px auto 0px auto;
        background-color: #008080;
        width: 640px;
        color: #ffffff;
...
<li><a href="order_form_and_handle.php">Order Product</a></li>
</ul>
</div>