...
<style type ="text/css">
    ...
    #list_users table tr td.second, #list_users table tr td.fourth, #list_supplements table tr td.second, #list_supplements table tr td.fourth, #list_supplements table tr td.sixth, #list_orders tadle tr td.second, #list_orders table tr td.fourth, #list_orders table tr td.sixth, #list_orders table tr td.eighth {
        background: olive;
        color: white;
    }
    #ORDER_FORM {
    ...
    #admin_main_menu, #admin_main_menu, #list_users {
        margin: 0px auto 0px auto;
        background-color: #008080;
        width: 640px;
        color: #ffffff;
...
<div id="top_links">
<ul>
    <li><a href="order_form_and_handle.php">Order Products</a></li>
    <li><a href="registration_form_and_handle.php">Register</a></li>
</ul>
</div>