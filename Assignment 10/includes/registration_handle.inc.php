...
if(count($errors_array)==0){
	...
	$insert_into_hat_customers = "INSERT INTO customers (first_name, last_name, email, phone, password, address_1, address_2, city, hat_states_id, zip, date_created) VALUES
	...
	if(!$exec_insert_into_hat_customers){
		rollback("The following error occurred when inserting into customers: ".mysqli_error($link));
	}else{
